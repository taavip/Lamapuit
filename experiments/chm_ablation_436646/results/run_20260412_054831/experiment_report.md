...
|---:|---:|---|---:|---:|---:|---:|
| 1 | 2018 | 436646_2018_madal_cdw_features_lowest_all_all_20cm.tif | 0.0208 | 0.0114 | 0.1250 | 4 |

## Top Variants (Across Years)

| rank | variant_id | mean_f1 | mean_recall | n_years | n_model_chm_cases |
|---:|---|---:|---:|---:|---:|
| 1 | madal_cdw_features_lowest_all_all_20cm | 0.0208 | 0.0114 | 1 | 4 |
...
| v2 | s2_convnext_small_full_ce_mixup_swa_tta_0_ep_60_focused_df4d4976 | convnext_small | 0.0000 | 0.0000 | 0.0000 | 1 |
