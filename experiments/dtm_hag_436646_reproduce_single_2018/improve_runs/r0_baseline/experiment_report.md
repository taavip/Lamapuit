...
- idw_k3_raw: AUC(tile_max)=0.6267493257556379, J(tile_max)=0.20053787440429338 @thr=1.2934646606445312, J(frac>=15cm)=0.2424647294454806 @thr=0.11181959667813615, CDW>=15cm=1.0, NoCDW>=15cm=0.9913256227758007
- idw_k3_gauss: AUC(tile_max)=0.5498953244940684, J(tile_max)=0.1614077986356175 @thr=0.8064696687810562, J(frac>=15cm)=0.23854048446257886 @thr=0.17976031111732654, CDW>=15cm=1.0, NoCDW>=15cm=0.9810943060498221
- idw_k6_raw: AUC(tile_max)=0.6290307209572035, J(tile_max)=0.20140877337194196 @thr=1.29547119140625, J(frac>=15cm)=0.2424647294454806 @thr=0.11185412796741584, CDW>=15cm=1.0, NoCDW>=15cm=0.9913256227758007
- idw_k6_gauss: AUC(tile_max)=0.5494407838370092, J(tile_max)=0.16026512207175547 @thr=0.8057022094726562, J(frac>=15cm)=0.23762022782754239 @thr=0.17979891011424057, CDW>=15cm=1.0, NoCDW>=15cm=0.9810943060498221
- tin_linear_raw: AUC(tile_max)=0.6303333443017038, J(tile_max)=0.20255144993580398 @thr=1.295255091050092, J(frac>=15cm)=0.2424647294454806 @thr=0.11193720453954725, CDW>=15cm=1.0, NoCDW>=15cm=0.9913256227758007
- tin_linear_gauss: AUC(tile_max)=0.5459812459489461, J(tile_max)=0.1601985357846193 @thr=0.8331444859504701, J(frac>=15cm)=0.23854048446257886 @thr=0.1795147024398564, CDW>=15cm=1.0, NoCDW>=15cm=0.9810943060498221
- tps_raw: AUC(tile_max)=0.6259071411542368, J(tile_max)=0.21711972245469646 @thr=1.295684814453125, J(frac>=15cm)=0.17238072207473565 @thr=0.22592295711878438, CDW>=15cm=1.0, NoCDW>=15cm=0.9986654804270463
- tps_gauss: AUC(tile_max)=0.532065953639802, J(tile_max)=0.11732674527470177 @thr=0.8715254068374634, J(frac>=15cm)=0.21190239971391184 @thr=0.26855891778196356, CDW>=15cm=1.0, NoCDW>=15cm=0.994661921708185
...
## Output Artifacts
- JSON report: experiments/dtm_hag_436646_reproduce_single_2018/improve_runs/r0_baseline/experiment_report.json
- CSV summary: experiments/dtm_hag_436646_reproduce_single_2018/improve_runs/r0_baseline/eval/method_summary.csv
- This Markdown report: experiments/dtm_hag_436646_reproduce_single_2018/improve_runs/r0_baseline/experiment_report.md
