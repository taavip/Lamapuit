...
- harmonized_dem_raw: AUC(tile_max)=0.5203454477951092, J(tile_max)=0.04064169313562116 @thr=0.699999988079071, J(frac>=15cm)=0.4063408770888537 @thr=0.4806487305915744, CDW>=15cm=1.0, NoCDW>=15cm=0.9913256227758007
- harmonized_dem_gauss: AUC(tile_max)=0.5354545592825941, J(tile_max)=0.07086022653617208 @thr=0.699999988079071, J(frac>=15cm)=0.41554344343921745 @thr=0.4771510188180887, CDW>=15cm=1.0, NoCDW>=15cm=0.9911032028469751
...
## Output Artifacts
- JSON report: experiments/dtm_hag_436646_reproduce_single_2018/improve_rounds_2026_04_15/r6_only_raw_gauss/experiment_report.json
- CSV summary: experiments/dtm_hag_436646_reproduce_single_2018/improve_rounds_2026_04_15/r6_only_raw_gauss/eval/method_summary.csv
- This Markdown report: experiments/dtm_hag_436646_reproduce_single_2018/improve_rounds_2026_04_15/r6_only_raw_gauss/experiment_report.md
