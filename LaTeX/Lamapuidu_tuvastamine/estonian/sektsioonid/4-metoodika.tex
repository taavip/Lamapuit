...
\paragraph{Maapinna kõrgusmudelite (DTM) arvutamise erinevused ja nende mõju.}
Baasmudeli ja harmoniseeritud toor-CHM-i peamine erinevus seisneb maapinna kõrgusmudeli (ingl \textit{Digital Terrain Model} ehk DTM) loomise ja punktide kõrguste maapinnast suhestamise metoodikas. Mõlemad lähenemised toovad esile erinevaid ruumilisi andmekihte ning omavad oma kindlaid eeliseid, mistõttu on oluline analüüsida nende mõlema panust.
...
Harmoniseeritud toor-CHM kasutab aga matemaatiliselt siledamat, laiemale piirkondlikule kontekstile toetuvat ning naaberaladega kokku sobitatud (harmoniseeritud) maapinnamudelit. Töötluse käigus  eemaldatakse järsud ebaloomulikud lokaalsed anomaaliad ning tuuakse välja pidevam geograafiline reljeef. Harmoniseeritud meetodi vaieldamatu tugevus on maapinna loomuliku mikrostruktuuri (nt nõod, künkad, mättad ja lohud langenud puu ümbruses) märgatavalt selgem väljajoonistumine, mis muidu müraste lokaalsete kõikumiste sekka ära kaoksid. Kui stabiilne ja ühtlustatud maapind on taustaks, tulevad esile ka need madalama reljeefiga lamapuidu osad, mis puutuvad tihedalt pinnasega kokku või on kõrge lagunemisastmega ning seetõttu maastikku sulandunud. 

Lisades mudelile infokilde mõlemast allikast (näiteks mitmekanalilises liitmudelis), võimendab baasmudeli krobelisem iseloom kõrgeid objektipunkte, samas kui harmoniseeritud mudel pakub kõrge lahutusvõimega ja selge fooni metsaaluse mikrostruktuuri eraldamiseks tihedatest peegeldustest.
