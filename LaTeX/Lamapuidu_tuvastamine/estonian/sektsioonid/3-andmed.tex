...
Kuna käsitsi segmenteerimine on äärmiselt ajamahukas protsess, ei ole seda võimalik ega ka otstarbekas läbi viia üle-eestilises mastaabis. Seetõttu valiti lamapuidu tuvastamise metoodika ja mudelite treenimise toimivuse katsetamiseks eraldiseisvalt välja üks konkreetne kaardileht (tähisega \texttt{406455\_2021\_tava}), et luua usaldusväärne segmentatsiooni treeningandmestik. Valik langes osale Ruhnu saarest, kuna sealsed metsad on vanad, reljeefi osas mitmekesised ja sisaldavad suurel hulgal lamapuitu. Akadeemiliselt on sellise kontrollala valik põhjendatud asjaoluga, et treeningandmete koostamisel on kriitilise tähtsusega objektide varjatus ja tihedus -- mida rohkem edukaid ja erinevates lagunemisastmetes lamatüvesid andmestikku kaasatakse, seda paremini suudab mudel õppida lamapuidule iseloomulikke jooni erinevates metsatingimustes.

Ruhnu saare valituid metsades on rikkalikult vanu ja mitmekesise puistustruktuuriga eraldisi. Näiteks paiknevad antud kaardilehel üle 140 aasta vanused männi- ja kuusemetsad (Ruhnu vald, Kirikumaa üksus: 2,5 ha, keskmine vanus 140 aastat, peapuuliigiks mänd loodusliku kuusega, sinilille kasvukohatüüp), samuti mitmekesiseid lehtpuumetsi (Steffenss üksus: 0,69 ha, 67-aastane sanglepamets angervaksa kasvukohatüübis, koos loodusliku kase, vahtra ja saarega). Selline liigiline ja vanuseline mitmekesisus peegeldab keerulist ja reljeefset metsaalust, millest mudel peab objektid tuvastama. Samuti teostati antud alal aerolaserskaneerimine tiheasustusala kaardistuse parameetritega, mille käigus lennati tavapärasest madalamalt. See tõi kaasa märgatavalt suurema punktitiheduse maapinnalähedastes kihtides (keskmiselt 43,7 p/m$^2$), mis esindab ideaalset andmestikku kõrgresolutsioonilise referentsi märgistamiseks (vt Tabel \ref{tbl:laz_dataset_overview}).

Andmestiku statistika näitab tabelis \ref{tbl:laz_dataset_overview}, et uuritavad Maa- ja Ruumiameti aerolaserskaneerimise andmed katavad kokku 27 km$^2$ uuringuala 29 kaardilehel, kogusummas aga 117 km$^2$ (arvestades kõiki aastate ülelendude kordusi). Andmestik sisaldab kokku 4,45 miljardit laserpunkti keskmise tihedusega 37,86 pts/m$^2$ (vahemikus 11,81--81,32 pts/m$^2$). See on märkimisväärselt kõrgem tihedus võrreldes tiheasustusala lende dokumenteeritud tihedusega. Antud andmeid kasutati magistritöös madala taimkatte mudelite loomiseks.
...
\begin{table}[ht]
\centering
\caption{Andmete jaotus aastate lõikes.}
\label{tbl:laz_per_year}
\begin{tabular}{lrrrr}
\hline
\textbf{Aasta} & \textbf{Ruute} & \textbf{Pindala (km$^2$)} & \textbf{Punkte (mln)} & \textbf{Tihedus (p/m$^2$)} \\
\hline
2017 & 11 & 11 & 266,7 & 24,25 \\
2018 & 17 & 17 & 553,0 & 32,53 \\
2019 & 13 & 13 & 521,5 & 40,12 \\
2020 & 18 & 18 & 723,2 & 40,18 \\
2021 & 14 & 14 & 527,6 & 37,68 \\
2022 & 26 & 24 & 1040,5 & 42,05 \\
2023 & 12 & 12 & 481,4 & 40,12 \\
2024 & 8 & 8 & 338,9 & 42,36 \\
\hline
\textbf{Kokku} & \textbf{119} & \textbf{117} & \textbf{4452,7} & \textbf{37,86} \\
\hline
\end{tabular}
\end{table}
