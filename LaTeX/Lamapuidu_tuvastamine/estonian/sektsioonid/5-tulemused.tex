...
\textbf{Joonis 5.1.} ROC-kõver ja saagis-täpsuse kõver (PR) lõpliku ansambli kohta testandmestikul.\
Placeholder}}
...
Eksperimendid mitme kanaliga (koondades suhtelisikõrguseid ja silutud väärtusi) pakkusid küll marginaalset täpsuse kasvu (alla 1\% F1 suhtes), kuid suurendasid andmemahtu ja iteratsioonide aega enam kui kolm korda. Tehtud kuluanalüüsist lähtuvalt otsustati 1-kanalise 20 cm rasteri kasuks, mis pakub kõige efektiivsema tasakaalu andmelihtsuse, arvutusresursside ja lõpliku tuvastusvõimekuse vahel.
...
Pärast faasi 5 võitjate lukustamist viidi faasis 6 läbi üksik lõpphindamine eraldatud testvalimil kolmele eeldefineeritud mudelile: kaks top-kombinatsiooni ja eelnev standardkonfiguratsioon (\texttt{2A\_\_3C\_\_4H\_\_5D}). Tabel~\ref{tab:seg-final-test} koondab lõppnäitajad.
