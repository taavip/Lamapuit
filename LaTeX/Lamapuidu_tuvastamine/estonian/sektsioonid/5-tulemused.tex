...
Pärast faasi 5 võitjate lukustamist viidi faasis 6 läbi üksik lõpphindamine eraldiseisval testvalimil (ingl \textit{held-out test}) kolmele eelnevalt määratud mudelile: kaks parimaks osutunud kombinatsiooni ja eelnev standardkonfiguratsioon (\texttt{2A\_\_3C\_\_4H\_\_5D}). Tabel~\ref{tab:seg-final-test} koondab lõppnäitajad.
