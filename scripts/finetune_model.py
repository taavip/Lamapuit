...
def main():
    ...
    parser.add_argument(
        "--model", type=str, required=True, help="Path to base model weights (best.pt)"
    )
    parser.add_argument("--data", type=str, required=True, help="Path to dataset YAML file")
    parser.add_argument(
        "--epochs", type=int, default=10, help="Number of additional epochs (default: 10)"
    )
    parser.add_argument("--batch", type=int, default=4, help="Batch size (default: 4)")
    parser.add_argument("--imgsz", type=int, default=640, help="Image size (default: 640)")
    parser.add_argument("--project", type=str, default="runs/cdw_detect", help="Project directory")
    parser.add_argument(
        "--name",
        type=str,
        default="finetune_v1.0.0",
        help="Experiment name (use semantic versioning like finetune_v1.0.0)",
    )
    parser.add_argument("--config", type=str, help="Optional config file to load defaults from")
